        ...
        dateClick: function (dateClickInfo) {
            ...
            if (scheduleMap.has(date_string)) {
                ...
                if (!schedule["fully_booked"]) {
                    ...
                    $('#schedule-event-form-container').show();
                    $('#schedule-event-form-container .modal-content').slideDown(250);
                }
            }
        }
    });

    $('#schedule-event-form-container .close').click(function () {
        $('#schedule-event-form-container .modal-content').slideUp(250);
        $('#schedule-event-form-container').delay(150).fadeOut(250);
    });
